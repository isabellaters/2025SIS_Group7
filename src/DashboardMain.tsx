...
export default function DashboardMain({ sidebarCollapsed }: DashboardMainProps) {
  function handleSubjectClick(subjectName: string) {
    alert(`You clicked on ${subjectName}`); // Replace with navigation later
  }
    ...
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
          ...
          {/* New Subject card */}
          <div style={{ border: '1.5px dashed #cacaca', borderRadius: 16, background: '#f9f9f9', padding: '24px', height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#888', fontSize: '1.11rem', flexDirection: 'column', gap: 5, cursor: 'pointer' }}>
      ...
      <aside style={{ width: 320, background: '#fff', borderLeft: '1px solid #eee', padding: '48px 38px 24px 38px', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
